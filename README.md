...
## Included in version 0.8.0-beta.128
...
`release` folder. The resulting `BYAKUGAN-Setup-0.8.0-beta.128-x64.exe` installs
...
exact application version prefixed by `v`—for example `v0.8.0-beta.128`. Upload
...
example `0.8.0-beta.128`, before rebuilding and uploading all three artifacts.
