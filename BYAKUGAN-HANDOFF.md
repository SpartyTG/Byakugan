...
`BYAKUGAN-CURRENT-HANDOFF.md`, and this package targets `v0.8.0-beta.136`.

## Verified baseline

- Previous canonical version: `v0.8.0-beta.130`
- Automated tests: `199 passed, 0 failed`, plus `10` Sensei Brain smoke checks
...
Install beta.136 on both PCs and follow the manual verification in
